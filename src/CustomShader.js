...
//     ],
//     function(PIXI, deepMixIn) {

var CustomShader = (function () {

    var deepMixIn = mout.object.deepMixIn;
    ...
    function CustomShader(cfg) {
        ...
        deepMixIn(this, {
            ...
            uniforms : {
                // store the value in the CustomObject
                // uTime:  { type: '1f'},
    ...
    var _p = CustomShader.prototype = Object.create(PIXI.ObjectRenderer.prototype);
    _p.constructor = CustomShader;
    ...
    PIXI.CustomShader = CustomShader;
